...
<head>
    ...
    <!-- MDL  -->
    <link rel="stylesheet" href="https://code.getmdl.io/1.3.0/material.indigo-pink.min.css"> <link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
        ...
        <section class="right-wrap right-active">
            <div class="container-fluid main-content mt-10">
                <div class="d-flex justify-content-center text-center">
                    <div class="col-12">
                        <div class="container d-flex packages">
                            <div class="col-4 student">
                                <div class="card" style="width: 18rem;">
                                    <div class="card-body">
                                        <h5 class="card-title">Are you a student</h5>
                                        <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                                        <a href="<?php echo $studentRegistrationLink; ?>" class="btn btn-primary">Create as Student</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-4 teacher">
                                <div class="card" style="width: 18rem;">
                                    <div class="card-body">
                                        <h5 class="card-title">Are you a Teacher</h5>
                                        <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                                        <a href="<?php echo $teacherRegistrationLink; ?>" class="btn btn-primary">Create as Teacher</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-4 other">
                                <div class="card" style="width: 18rem;">
                                    <div class="card-body">
                                        <h5 class="card-title">Are you a Other</h5>
                                        <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                                        <a href="#" class="btn btn-primary">Create as Other</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container-fluid">
                <h4>Get started with Angular</h4>
                <div class="row">
                    <div class="col-md-3 mb-10"><div class="card" style="width: 18rem;">
                            <div class="card-body">
                                <iframe width="420" height="150"
...
<script>
    ...
    //         e.preventDefault();
    //       $(".main-slid-menu").toggleClass("active");
    //       $(".right-wrap").toggleClass("right-active");
    //       $(".main-content").toggleClass("main-active");
    // });
    // });
</script>
