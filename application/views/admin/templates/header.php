...
<nav class="navbar navbar-success bg-success navbar-static-top" style="background-color: midnightblue;">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php echo base_url('admin/dashboard') ?>">Tutor.lk</a>
    </div>

    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li id="topNavDashboard"><a href="<?php echo base_url('admin/dashboard') ?>"> <i class="glyphicon glyphicon-dashboard"></i> Dashboard <span class="sr-only">(current)</span></a></li>
        ...
        <li class="dropdown" id="topClassMainNav">
          ...
          <ul class="dropdown-menu">            
            <li id="topNavClass"><a href="<?php echo base_url('admin/classes'); ?>">Manage Class</a></li>
            <li id="topNavSection"><a href="<?php echo base_url('admin/section') ?>">Manage Section</a></li>
            <li id="topNavSubject"><a href="<?php echo base_url('admin/subject') ?>">Manage Subject</a></li>
          </ul>
        </li>
        <li class="dropdown" id="topStudentMainNav">
          ...
          <ul class="dropdown-menu">
            <li id="addStudentNav"><a href="<?php echo base_url('admin/student?opt=addst') ?>">Add Student</a></li>
            <li id="addBulkStudentNav"><a href="<?php echo base_url('admin/student?opt=bulkst') ?>">Add Bulk Student</a></li>
            <li id="manageStudentNav"><a href="<?php echo base_url('admin/student?opt=mgst') ?>">Manage Student</a></li>
          </ul>
        </li>
        <li id="topNavTeacher"><a href="<?php echo base_url('admin/teacher') ?>"> <i class="glyphicon glyphicon-briefcase"></i> Teacher</a></li>
        ...
        <li class="dropdown" id="topAttendanceMainNav">
          ...
          <ul class="dropdown-menu">
            <li id="takeAttendNav"><a href="<?php echo base_url('admin/attendance?atd=add') ?>">Take Attendance</a></li>
            <li id="attenReport"><a href="<?php echo base_url('admin/attendance?atd=report') ?>">Attendance Report</a></li>
          </ul>
        </li>       
        <li class="dropdown" id="topMarksheetMainNav">
          ...
          <ul class="dropdown-menu">
            <li id="manageMarksheet"><a href="<?php echo base_url('admin/marksheet?opt=mngms') ?>">Manage Marksheet</a></li>
            <li id="manageMarks"><a href="<?php echo base_url('admin/marksheet?opt=mgmk') ?>">Manage Marks</a></li>
          </ul>
        </li>
        ...
        <li class="dropdown" id="topAccountMainNav">
          ...
          <ul class="dropdown-menu">
            <li id="createStudentNav"><a href="<?php echo base_url('admin/accounting?opt=crtpay') ?>">Create Student Payment</a></li>
            <li id="managePayNav"><a href="<?php echo base_url('admin/accounting?opt=mgpay') ?>">Manage Payment</a></li>
            <li id="expNav"><a href="<?php echo base_url('admin/accounting?opt=mgexp') ?>">Expenses</a></li>
            <li id="incomeNav"><a href="<?php echo base_url('admin/accounting?opt=ime') ?>">Income</a></li>
          </ul>
        </li>
      </ul>      
