...
<div class="modal fade" tabindex="-1" role="dialog" id="addTeacher">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form class="form-horizontal" method="post" id="createTeacherForm" action="<?php echo base_url('admin/teacher/create') ?>" enctype="multipart/form-data">
      ...
      <div class="modal-body edit-modal">
	  	...
	  	<div class="tab-content">
	    	<div role="tabpanel" class="tab-pane active" id="home">
	    		<br /> 
                <form class="form-horizontal" method="post" id="updateTeacherPhotoForm" action="<?php echo base_url('admin/teacher/updatePhoto') ?>" enctype="multipart/form-data">
	    	...
	    	<br /> 
    		<form class="form-horizontal" method="post" action="<?php echo base_url('admin/teacher/updateInfo') ?>" id="updateTeacherInfoForm">
			  	<div class="row">
