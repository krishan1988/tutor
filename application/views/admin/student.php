...
<div class="panel panel-default">
  ...
  <div class="panel-body">
      ...
      if($this->input->get('opt') == 'addst') {
        // echo "Add Student";
        ?>
        <form action="<?php echo base_url('admin/student/create') ?>" method="post" id="createStudentForm" enctype="multipart/form-data">
          <div class="col-md-7">
          <fieldset>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="tab-content">
        ...
        <form class="form-horizontal" method="post" id="updateStudentPhotoForm" action="admin/student/updatePhoto" enctype="multipart/form-data">
        ...
        <br /> 
        <form class="form-horizontal" method="post" action="admin/student/updateInfo" id="updateStudentInfoForm">
          <div class="row">
